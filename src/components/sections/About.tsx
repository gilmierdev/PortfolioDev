        ...
        <div className="grid gap-10 items-start mt-12 sm:grid-cols-5">
          <Reveal className="sm:col-span-3">
            ...
            <h3 className="font-display font-semibold text-xl mt-10 mb-4 flex items-center gap-3">
              <span aria-hidden="true" className="w-8 h-8 rounded-lg bg-primary/10 border border-primary/20 text-primary grid place-items-center text-sm">
                ▸
              </span>
              What drives me
            </h3>
            <ul className="grid gap-4 sm:grid-cols-2">
              {CONFIG.traits.map((trait, i) => (
                <li
                  key={trait.name}
                  className="rounded-2xl border border-border bg-surface p-5 flex flex-col gap-2 transition-colors hover:border-primary/50"
                >
          ...
          <Reveal as="aside" className="sm:col-span-2 flex justify-center" aria-label="Student ID card">
            <div
              ref={idCardRef}
              ...
              className="relative pt-11 transition-transform duration-200 ease-out select-none"
            >
              <div
                aria-hidden="true"
              ...
              <div className="relative w-full max-w-[420px] rounded-2xl overflow-hidden bg-white text-slate-800 shadow-[0_16px_40px_-16px_rgba(0,0,0,.4)] dark:shadow-[0_16px_40px_-12px_rgba(0,0,0,.75)] pb-5">
                ...
                />
              <div className="bg-primary px-6 pt-5 pb-4 flex items-center justify-between text-white">
                <div>
